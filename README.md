...
## 简介
ECMAScript 6，又称为ECMAScript 2015，是ECMAScript标准的最新版本。ES6是该语言更新的一个里程碑，并且第一次主要的更新是在2009年ES5被确立标准之后。主流JavaScript引擎对这些特性的实现正在如火如荼地[进行中](http://kangax.github.io/es5-compat-table/es6/)。
